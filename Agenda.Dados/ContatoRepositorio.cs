...
namespace Agenda.Dados
{
    ...
    {
        public List<ContatoRepositorio> ConsultarContatos()
        {
            List<ContatoRepositorio> retornoConsulta = new List<ContatoRepositorio>();

            string comandoSQL = "SELECT * FROM Contato;";

            MySqlConnection conexao = new MySqlConnection("Server=localhost;Database=AgedaContato;Uid=root;Pwd=;");
